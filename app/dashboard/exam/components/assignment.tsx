...
export default function Assignment({
  ...
  }, [assessmentAssignment, searchQuery, statusFilters]);
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100">
          ...
          <div className="p-4 flex items-baseline gap-2">
            <span className="text-3xl font-bold text-gray-800">{assessmentAssignment?.summary.submitted || 0}</span>
            <span className="text-gray-500 text-sm">Assignment</span>
          </div>
        </div>
        <div className="bg-green-600 px-4 py-2 text-white text-sm font-bold rounded-t-xl hidden">Done</div>
        <div className="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100">
          <div className="bg-green-600 px-4 py-2 text-white text-sm font-bold">Done</div>
          <div className="p-4 flex items-baseline gap-2">
            <span className="text-3xl font-bold text-gray-800">{assessmentAssignment?.summary.done || 0}</span>
            <span className="text-gray-500 text-sm">Assignment</span>
          </div>
        </div>
        <div className="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100">
